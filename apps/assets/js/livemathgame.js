import { database, ref, onValue, push } from './firebase-init.js';
        ...
        import('./basePath.js')
            ...
            .catch(() => {
                console.warn('basePath helper missing; using local fallback in livemathgame.');
            });
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function highScoresPath() {
                return atPath(DATABASE_BASE_PATH, 'highScores');
            }
            ...
            function gameOver() {
                ...
                const highScoresRef = ref(database, highScoresPath());
                push(highScoresRef, {
                    score: score,
                    time: timeTaken,
                    initials: initials
